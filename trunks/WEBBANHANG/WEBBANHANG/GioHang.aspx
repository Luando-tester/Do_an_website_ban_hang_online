<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="GioHang.aspx.cs" Inherits="WEBBANHANG.GioHang" %>
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="chose_area">
						...
						<a class="btn btn-default update" href="">Lấy Trích Dẫn</a>
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<a class="btn btn-default check_out" href="ThanhToan.aspx">Thanh Toán</a>
					</div>
				</div>
			</div>
		</div>
