<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.Master" AutoEventWireup="true" CodeBehind="SuaSanPham.aspx.cs" Inherits="WEBBANHANG.ADMIN.SuaSanPham" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 820px">
        ...
        <tr>
            ...
            <td style="width: 620px; height: 24px;">
                <asp:Button ID="btnCapNhat" OnClick="capnhat_click" runat="server" Text="Cập nhật"  />
                <asp:Button ID="btnXoa" OnClick="Xoa_click" runat="server" Text="Xóa"  />
